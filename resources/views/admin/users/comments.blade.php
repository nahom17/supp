    ...
    <div class="row justify-content-center g-5">
        <div class="col-md-8">
            ...
            <ul class="nav nav-tabs justify-content-center border-0 mt-5 mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark custom-tab-active" href="{{ route('admin.users.comments', $user) }}">Comments</a>
                </li>
                <li class="nav-item">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#comment{{ $comment->id }}">Bekijken</a></td>
                            </tr>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row mb-2">
                                                <div class="col-md-1 ">
                                                    <img src="{{ asset('uploads/profileImage/' . $comment->user->image) }}" alt="avatar" width="32" height="32" class="rounded-circle">
                                                </div>
                                                <div class="col text-start">
                                                    <div class="col fw-bold">
                                                        {{ $comment->user->name }}
                                                ...
                                                <div class="col text-end">
                                                    <div class="col text-end">
                                                        <a href="{{ route('admin.posts.show', $comment->post) }}" class="text-decoration-none">Post bekijken</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col text-end">
                                                    <form action="{{ route('admin.users.delete', [$user, $comment]) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger">Verwijderen</button>
                                                    </form>
