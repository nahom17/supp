        ...
        <div class="col-md-8">
            ...
            <div class="col">
                <ul class="nav nav-tabs justify-content-center border-0 mt-3 mb-3">
                    <li class="nav-item">
                        <a class="nav-link text-dark custom-tab-nonactive" aria-current="page" href="{{ route('admin.posts.index') }}">Overzicht</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark custom-tab-active" aria-current="page" href="{{ route('admin.posts.reported') }}">Gerapporteerde posts</a>
                    </li>
