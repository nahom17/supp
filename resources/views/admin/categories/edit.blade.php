            ...
            <div class="row">
                ...
                <div class="col">
                    <ul class="nav nav-tabs justify-content-center border-0 mt-3 mb-3">
                        ...
                        <li class=" nav-item">
                            <a class="nav-link text-dark custom-tab-active disabled" href="{{ route('admin.categories.edit', $category) }}">Bewerken</a>
                        </li>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="staticBackdropLabel">Weet je zeker dat je deze categorie wilt verwijderen?</h5>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                        ...
                        <div class="col mb-3">
                            ...
                            <textarea type="text" name="description" id="description" class="form-control" value="{!! $category->description !!}">{!! $category->description !!}</textarea>
                        </div>

                        <div class="col text-end">
                            <a href="{{ route('admin.categories.index', $category) }}" class="text-decoration-none me-2">Annuleren</a>
