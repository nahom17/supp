            ...
            <div class="row justify-content-center text-center g-5">
                ...
                <div class="col-md-6 m-5">
                    ...
                    <ul class="nav nav-tabs justify-content-center border-0 mt-3 mb-3">
                        <li class="nav-item">
                            <a class="nav-link text-dark custom-tab-active" href="">Alle posts</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark custom-tab-nonactive" href="{{ route('categories.CategoryPrivateShow', $category) }}">Privé</a>
                        </li>
