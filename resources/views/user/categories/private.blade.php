        ...
        <div class="container mt-3">
            <div class="row justify-content-center text-center g-5">
                ...
                <div class="col-md-6 m-5">
                        ...
                        <div class="card-body">
                            <div class="row mb-0">
                                <div class="col">
                                    ...
                                    <a href="{{ route('login') }}" class="text-decoration-none">{{ $post->user->name }}</a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                    ...
                    <p>Meer lezen? <a href="{{ route('login') }}">Log in</a></p>
                    @else
                    <div class="alert alert-warning text-center mt-4" role="alert">
                        Deze categorie heeft nog geen posts
                    </div>
                    ...
                    <ul class="nav nav-tabs justify-content-center border-0 mt-3 mb-3">
                        <li class="nav-item">
                            <a class="nav-link text-dark custom-tab-nonactive" href="{{ route('categories.CategoryShow', $category)}}">Alle posts</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark custom-tab-active" href="{{ route('categories.CategoryPrivateShow', $category) }}">Privé</a>
                        </li>
                        ...
                        <div class="card-body text-start">
                            <form action="{{ route('posts.storePost') }}" method="post">
                                ...
                                <div class="col text-end">
                                    <button class="btn btn-sm btn-dark">Verstuur</button>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card mb-3 mt-4  text-start ">
                                <div class="card-body">
                                        ...
                                        <div class="col-md-2 text-end">
                                            <div class="dropdown-center">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#report{{ $post->id }}">Rapporteren</a></li>
                                                    @endif
                                                    <li><a href="{{ route('categories.showPost', [$category, $post->post]) }}" class="dropdown-item">Comments</a></li>
                                                    @if($post->user->id == Auth::user()->id)
                                    ...
                                    <div class="card border-0">
                                        <div class="card-body ps-0" style="transform: rotate(0);">
                                            <a href="{{ route('categories.showPost', [$category, $post->post]) }}" class="stretched-link"></a>
                                            {!! $post->post->content !!}
                                        </div>
                    ...
                    <div class="card mb-3 mt-4 border-0 text-start post">
                        <div class="card-body">
                                ...
                                <div class="col-md-2 text-end">
                                    <div class="dropdown-center">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#report{{ $post->id }}">Rapporteren</a></li>
                                            @endif
                                            <li><a href="{{ route('categories.showPost', [$category, $post]) }}" class="dropdown-item">Comments</a></li>
                                            @if($post->user->id == Auth::user()->id)
                                            <li><a href="" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit{{ $post->id }}">Bewerken</a></li>
                                            <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#post{{ $post->id }}">Verwijderen</a></li>
                                            @endif
                            ...
                            <div class="card border-0">
                                <div class="card-body ps-0" style="transform: rotate(0);">
                                    <a href="{{ route('categories.showPost', [$category, $post]) }}" class="stretched-link"></a>
                                    {!! $post->content !!}
                                </div>
