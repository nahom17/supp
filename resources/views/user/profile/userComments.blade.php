            ...
            <div class="row justify-content-center text-center g-5">
                ...
                <div class="col-md-6 m-5">
                    ...
                    <ul class="nav nav-tabs justify-content-center border-0 mt-3 mb-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark custom-tab-active" href="{{ route('profile.comments', $user->name) }}">Comments</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="col text-start text-muted fs-6">
                        Aantal comments <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                            <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
                        </svg> {{count($user->comments)}}
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card border-0">
                                <div class="card-body ps-0" style="transform: rotate(0);">
                                    <a href="{{ route('categories.showPost', [$comment->post->category, $comment->post]) }}" class="stretched-link"></a>
                                    {!! $comment->content !!}
                                </div>
                            ...
                            <div class="row">
                                <!-- <div class="col">
                                    <a href="#" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#comment{{ $comment->post->id }}">{{count($comment->post->comments)}} Comments</a>
                                </div>
                                <div class="col">
                                    <a href="">Like</a>
                                </div> -->
                    ...
                    <div class="modal fade" id="comment{{ $comment->post->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body text-start">
                                    ...
                                    <div class="row mb-0">
                                        <div class="col">
                                            ...
                                            <a href="{{ route('profile.user', $comment->post->user->name) }}" class="text-decoration-none"><img src="{{ asset('uploads/profileImage/' . $comment->post->user->image) }}" alt="avatar" width="32" height="32" class="rounded-circle me-2">{{ $comment->post->user->name }}</a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                                                <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
                                            </svg>{{ $comment->post->created_at->diffForHumans() }}
                                    ...
                                    <form method="POST" action="{{ route('posts.comments.store', $comment->post) }}">
                                        @csrf
                                        <div class="col">
                    ...
                    <div class="alert alert-warning text-center" role="alert">
                        Deze gebruiker heeft nog geen comments
                    </div>
                    @endif
                </div>
