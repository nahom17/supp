                ...
                <div class="col-md-6">
                    ...
                    <div class="card mb-3 mt-4 border-0 text-start">
                        <div class="card-body">
                            <div class="row mb-0">
                                <div class="col">
                                    <a href="{{ route('profile.user', $user->name) }}" class="text-decoration-none"><img src="{{ asset('uploads/profileImage/' . $user->image) }}" alt="avatar" width="32" height="32" class="rounded-circle me-2">{{ $user->name }}</a>
                                </div>
                                <div class="col text-end">

                                    <a href="{{ route('profile.user', $user->name) }}" class="text-decoration-none">Bekijk profiel</a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card border-0">
                                <div class="card-body ps-0" style="transform: rotate(0);">
                                    <a href="{{ route('categories.showPost', [$post->category->name, $post]) }}" class="stretched-link"></a>
                                    {!! $post->content !!}
                                </div>
                                ...
                                <div class="modal-body text-start">
                                    ...
                                    <div class="row mb-0">
                                        <div class="col">
                                            ...
                                            <a href="{{ route('profile.user', $post->user->name) }}" class="text-decoration-none"><img src="{{ asset('uploads/profileImage/' . $post->user->image) }}" alt="avatar" width="32" height="32" class="rounded-circle me-2">{{ $post->user->name }}</a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                                                <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
                                            </svg>{{ date('d-m-Y', strtotime($post->created_at)) }}<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                                                <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
                                            </svg> {{$post->category->name}}
