...
<body class="antialiased" onload="typeWriter()">
    <style>
        .kaart-category:hover {
            background-color: #0d6efd !important;
            box-shadow: 10px 10px 10px;
        ...
        <div class="container py-4">
            <div class="p-5 mb-4 bg-light rounded-3">
                <div class="container-fluid py-5">
                    ...
                    <p class="col-md-8 fs04" id="subtitle"></p>

                </div>
                <div class="row align-items-md-stretch">

                    <div class="col-md-4 mb-3">
                        <div class="h-100 p-5 text-bg-dark rounded-3 kaart-category text-center" style="transform: rotate(0);">
                            <a href="https://discord.gg/hh8vVgWQ" class="stretched-link"></a>
                            <h1>Discord</h1>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="h-100 p-5 text-bg-dark rounded-3 kaart-category text-center" style="transform: rotate(0);">
                            <a href="mailto:someone@example.com" class="stretched-link"></a>
                            <h1>E-Mail</h1>
                        </div>
                    </div>
    ...
    <script>
        var i = 0;
        var item = 0;
        var txt = 'Contact met MessageBoard';
        var txt2 = 'Waar kun je ons bereiken?'
        var speed = 60;
        var speed2 = 60;
